...
- ✅ Íconos reales de casillas de trampa: `icono_puente/carcel/calavera/minijuego` (`assets/casillas/`) reemplazan los emojis, y la oca tiene animación de vuelo real de 3 frames (`oca_vuelo_animado.dart`) en vez de emoji+transform.
...
- ⚠️ **Inconsistencia de estilo detectada**: los íconos de casillas de trampa y el vuelo de la oca tienen un estilo "cristal/gema brillante sobre fondo oscuro" bien distinto al cartoon plano de los avatares y al tono pedido en este documento — la calavera en particular tiene ojos rojos brillantes e intensos, lo que choca con la sección 7 ("nunca oscuro/tétrico"). Se integraron igual porque son técnicamente correctos (transparencia real, tamaño adecuado), pero falta una pasada de consistencia visual si se quiere respetar el tono original al 100%.
